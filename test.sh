...
./RNMC --reaction_database=./test_materials/rn.sqlite --initial_state_database=./test_materials/initial_state_copy.sqlite --number_of_simulations=1000 --base_seed=1000 --thread_count=8 --step_cutoff=200 --gc_interval=5 --gc_threshold=1
